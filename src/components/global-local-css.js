  ...
  <GuestLayout>
    <div className="container p-b-md p-r-md p-l-md">
      ...
      <div className={`${localStyles.gray} p-t-xl p-b-xl p-l-md p-r-xl`}>
        ...
        className to hash like <code>{localStyles.gray}</code>
        . This one may include any library css such as `date-picker` or any
        general purpose css from `resources` folder.
      </div>
    </div>
  </GuestLayout>
)
